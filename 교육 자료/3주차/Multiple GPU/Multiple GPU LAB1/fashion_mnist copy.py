...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        print("Epoch = {:2d}: Epoch Time = {:5.3f}, Validation Loss = {:5.3f}, Validation Accuracy = {:5.3f}, Image Troughput = {:5.3f}".format(epoch+1, epoch_time, v_loss, val_accuracy[-1], images_per_sec))
        ...
        if epoch > args.patience and (val_accuracy[-args.patience:] > args.target_accuracy):
