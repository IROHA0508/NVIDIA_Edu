...
parser.add_argument('--node-id', type=int, default=0,
                    help='Unique ID to identity the current nodes')
args = parser.parse_args()

WORLD_SIZE = args.num_nodes*args.num_gpus
os.environ['MASTER_ADDR'] = 'localhost'
os.environ['MASTER_PORT'] = '7845'
...
def worker(local_rank, args):
    ...
    test_sampler = torch.utils.data.distributed.DistributedSampler(test_set, num_replicas = WORLD_SIZE, rank = global_rank)
